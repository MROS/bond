...
type Article = { title: string; id: number; content: string };

type Articles = { [key: string]: Article };
...
感謝卡友的理解和配合！`,
  ...
  '1': { title: '[問卦] 到底誰騙我經濟不好？', content: `出國人超多機場爆滿 我自己上個月剛從歐洲回來很清楚 不相信的自己去機場看
...
`, id: 1 },
	...
	'3': { title: '[小說轉載] 太平妖術', content: `轉載自 https://trow.cc/board/showtopic=49584
...
我面無表情地由人引導著走在迴廊中，面前的年輕僕人越走越慢，待到四下無人，我倆挨得很近的時候，年輕僕人突然塞給我兩冊書本，接著他又像什麼也沒發生一樣，加快腳步走到我的前面繼續領路。
果然，我突然求見，就算他們再拖延時間收拾，只要是會把東西搬出房外，光天化日下也會露出行跡。看來我這安插在這裡的探子，在我留在寢房的時候，還是有所收穫的。
出府的時候也沒被搜身，回到干王府，進入書房，我就取出了兩冊書本,這時仔細來看，分別是一冊很厚本子以及一本薄書。`, id: 3

}};

export const load: PageServerLoad = async ({ params }) => {
	return {
		post: articles[params.id]
	};
};
